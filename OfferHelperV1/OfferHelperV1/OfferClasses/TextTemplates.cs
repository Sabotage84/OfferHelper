...
namespace OfferHelperV1.OfferClasses
{
    class TextTemplates
    {
        ...
        string verificationExample = @"В качестве примера, если нужен Метроном-300 с поверкой, то это будет:
                                        ...
                                        OCXO-HQ, эл.пит. ~220В.
                                        6300 Евро с НДС.
                                        Антенна ГЛОНАСС/GPS Радиус-50 со встроенным грозоразрядником.
                                        435 Евро с НДС.
        ...
        string deliveryText = @"Оплата в рублях по курсу ЦБ.
                                Склад Москва 10-11 недель. Бывает на складе.
                                3 года гарантии. (Расширение гарантии до 5 лет +20% к стоимости).
                                Паспорт на изделие. Декларация соответствия ТС (EAC).";
